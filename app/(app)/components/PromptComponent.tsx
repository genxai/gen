    ...
    <>
      ...
      >
        ...
        <textarea
          ...
          className="w-full max-w-md p-3 px-4 border rounded-lg border-border bg-muted-foreground/70 placeholder:text-sm focus:outline-none resize-none text-left text-muted-foreground align-top placeholder:text-left placeholder:text-muted-foreground/50 placeholder:font-semibold"
