...
declare module "ronin" {
  ...
  export type Orders<TUsing extends Array<"fromUser"> | "all" = []> = Array<
    Order<TUsing>
  > & {
    moreBefore?: string
    moreAfter?: string
  ...
  export type ImageGeneration<
    TUsing extends Array<"createdByUser"> | "all" = [],
  > = ResultRecord & {
